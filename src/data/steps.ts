...
/** 8-step progress indicator. Case Launch + Modules 1-7 are active as of Phase 3C; Module 8 remains future/locked. */
export const steps: StepDefinition[] = [
  ...
  { id: 'module-5', order: 5, label: 'Module 5: IOC Quality Lab', shortLabel: 'M5', enabled: true },
  { id: 'module-6', order: 6, label: 'Module 6: Bias & Ethics Simulator', shortLabel: 'M6', enabled: true },
  { id: 'module-7', order: 7, label: 'Module 7: Weighted Rubric Sandbox', shortLabel: 'M7', enabled: true },
